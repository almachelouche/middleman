+++
markets = ["au"]
title = '''AU Prospect 010 Fiesta-1'''

[[module]]
path='email_modules/preheader'
color='''nothing'''

   preheader='''Pay just $15,990 for the vivid and stylish Ford Fiesta'''
...
color='''slatescreen'''
  ...
  copy='''<br />Hi <%${user.CustomAttribute['FullName']}%>,  <br /><br />
	...
	Right now, the Ford Fiesta Ambiente is available at $15,990* Driveaway.</span>'''
