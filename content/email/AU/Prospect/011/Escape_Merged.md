...
segmentif = ["(user.CustomAttribute['IMD'] == 'P2')"]
    ...
    cta2_url='''http://www.ford.com.au/latest-offers/national?offer=escape-ambiente-fwd-auto'''
...
segmentelse = ["(user.CustomAttribute['IMD'] == 'P1')"]
    ...
    cta1_url='''http://www.ford.com.au/latest-offers/national?offer=escape-ambiente-fwd-auto'''
		cta1_link_name = '''latestoffer1'''
...
color='white'
  ...
  title = '''Cover 13'''
  copy = '''<br />All this and more is available to you now in the New Ford Escape Ambiente Petrol FWD Auto.'''
...
segmentif = ["(user.CustomAttribute['IMD'] == 'P2')"]
  ...
  copy='''We know that a new car is a big decision <%${user.CustomAttribute['FullName']}%>, so our job isn't done once you pick up your car.<br /><br />
	...
	So don't wait. Book a test drive to experience the New Ford Escape Ambiente Petrol FWD Auto today.'''
  cta1_text='''BOOK A TEST DRIVE'''
  cta1_url='''https://www.ford.com.au/#overlay/content/ford/au/en_au/site-wide-content/overlays/forms/test-drive.html/'''
...
segmentelse = ["(user.CustomAttribute['IMD'] == 'P1')"]
  ...
  copy='''We know that a new car is a big decision <%${user.CustomAttribute['FullName']}%>, so our job isn't done once you pick up your car.<br /><br />
	...
	You can get State Auto Club Roadside Assistance and Membership&#179; for up to 7 years from Autoclub participating dealers. Ford also has a Free Loan Car program&#8308;, so we can keep you on the road whilst your car is being serviced.
	After all, that's what service should be.<br /><br />
	So don't wait. Check out the latest offers on the New Ford Escape Ambiente Petrol FWD Auto today.'''
  cta1_text='''LATEST OFFER'''
  cta1_url='''http://www.ford.com.au/latest-offers/national?offer=escape-ambiente-fwd-auto'''
  cta1_link_name = '''moreinfo2'''
...
color='white'
  ...
  text = '''Terms & Conditions<br /> <br />
	* Recommended driveaway price for 2017 plate models at participating Dealers. Private and Blue, Silver and Gold Business Fleet customers only. Stock may vary between Dealers. Vehicle must be purchased by 30/06/17 and delivered by 2/07/17. Eligible customers receive roadside assistance for 12 months or until an eligible A or B logbook service, whichever occurs first. Saving amount calculated by reference to prior recommended prices. Ford reserves the right to further reduce recommended price, or otherwise change or extend offer.<br /><br />
