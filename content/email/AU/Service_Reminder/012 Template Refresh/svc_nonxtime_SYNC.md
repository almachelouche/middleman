...
color='''white'''
	...
	copy = '''Hi <%${user.CustomAttribute['FullName']}%>,<br /><br />This is just a friendly reminder that your Ford <%${user.CustomAttribute['Model']}%> is nearly due for its <span style="color:#2D96CD"><%${user.CustomAttribute['Service_Interval']}%></span>km service.<br /><br />
