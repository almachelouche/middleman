+++
markets = ["ph"]
title = '''PH Welcome Repeat 003 Mustang'''
...
color='white'
	...
	copy = '''There’s nothing quite like a new car, whether it’s your first or your tenth. So we want to say ‘thank you!’ for choosing to make yours a Ford, again.<br /><br />As part of the Ford family, we’ll continue to stay in touch. But only with exciting news and the latest offers we reserve for loyal Ford owners. <br /><br />Until then, enjoy your Ford Mustang!'''
...
color='white'
	...
	title = '''Any questions?'''
	copy = '''Give us a call with any queries you may have about your new Mustang.<br />We'll be happy to help.'''
