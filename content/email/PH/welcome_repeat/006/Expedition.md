+++
markets = ["ph"]
title = '''PH Welcome Repeat 006 Expedition'''
...
color='white'
	...
	copy = '''There’s nothing quite like a new car, whether it’s your first or your tenth. So we want to say ‘thank you!’ for choosing to make yours a Ford, again.<br /><br />As part of the Ford family, we’ll continue to stay in touch. But only with exciting news and the latest offers we reserve for loyal Ford owners. <br /><br />Until then, enjoy your Ford Expedition!'''
...
title='''Customize Your Ford Expedition Today'''
copy='''Dress up your Expedition to your liking with our 100% genuine Ford accessories – the right accessories for your vehicle. <br /><br />Visit <%${user.CustomAttribute['Dealer_Name']}%> at <a style="color:#2D96CD" href="tel: <%${user.CustomAttribute['Dealer_Phone']}%>"><%${user.CustomAttribute['Dealer_Phone']}%></a> today to learn more about the latest accessories.'''
...
color='white'
	...
	title = '''Any questions?'''
	copy = '''Give us a call with any queries you may have about your new Expedition.<br />We'll be happy to help.'''
