+++
markets = ["ph"]
title = '''PH Welcome First 006 EcoSport'''
...
color='''white'''
	...
	copy = '''There’s nothing quite like a new car. So we want to say ‘thank you!’ for choosing a Ford.<br /><br />As part of the Ford family, you’ll be hearing from us from time to time, but only with news and offers we think you’ll appreciate.<br /><br />Until then, enjoy your Ford EcoSport!'''
...
copy='''Dress up your EcoSport to your liking with our 100% genuine Ford accessories – the right accessories for your vehicle. <br /><br />Visit <%${user.CustomAttribute['Dealer_Name']}%> at <%${user.CustomAttribute['Dealer_Phone']}%> today to learn more about the latest accessories.'''
