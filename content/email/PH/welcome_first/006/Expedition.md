+++
markets = ["ph"]
title = '''PH Welcome First 006 Expedition'''
...
color='''white'''
 ...
 title = '''Hello <%${user['FirstName']}%><br /><br />Hope you’re enjoying the ride'''
	copy = '''There’s nothing quite like a new car. So we want to say ‘thank you!’ for choosing a Ford.<br /><br />As part of the Ford family, you’ll be hearing from us from time to time, but only with news and offers we think you’ll appreciate.<br /><br />Until then, enjoy your Ford Expedition!'''
