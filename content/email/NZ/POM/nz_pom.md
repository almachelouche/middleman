...
path='email_modules/preheader'
	...
	preheader='''Hi <%${user.CustomAttribute['FullName']}%>,<br/><br/>Here's a quick reminder that your new <%${user.CustomAttribute['Model']}%> is due for its <br /> complimentary 2-month/3,000 km Peace Of Mind Service Inspection.'''
