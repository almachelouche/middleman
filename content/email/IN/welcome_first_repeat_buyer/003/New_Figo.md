+++
markets = ["in"]
title = '''IN Welcome 003 New Figo'''
draft = true

[[module]]
path='email_modules/preheader'
color='''nothing'''
segmentif = ["(user.CustomAttribute['Segment'] == 'I') || (user.CustomAttribute['Segment'] == 'J') || (user.CustomAttribute['Segment'] == 'Q') || (user.CustomAttribute['Segment'] == 'R')"]
...
path='email_modules/preheader'
color='''nothing'''
segmentelseif = ["(user.CustomAttribute['Segment'] == 'K') || (user.CustomAttribute['Segment'] == 'L') || (user.CustomAttribute['Segment'] == 'S') || (user.CustomAttribute['Segment'] == 'T')"]
...
color='white'
segmentif = ["(user.CustomAttribute['Segment'] == 'I') || (user.CustomAttribute['Segment'] == 'J') || (user.CustomAttribute['Segment'] == 'L') || (user.CustomAttribute['Segment'] == 'K')"]
...
path='email_modules/cover/01'
color='white'
segmentelseif = ["(user.CustomAttribute['Segment'] == 'Q') || (user.CustomAttribute['Segment'] == 'R') || (user.CustomAttribute['Segment'] == 'S') || (user.CustomAttribute['Segment'] == 'T')"]
...
color='white'
segmentif = ["(user.CustomAttribute['Segment'] == 'J') || (user.CustomAttribute['Segment'] == 'L') || (user.CustomAttribute['Segment'] == 'R') || (user.CustomAttribute['Segment'] == 'T')"]
