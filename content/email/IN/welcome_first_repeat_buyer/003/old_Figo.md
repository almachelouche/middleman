+++
markets = ["in"]
title = '''IN Welcome 003 Old Figo'''
draft = true

[[module]]
path='email_modules/preheader'
color='''nothing'''
segmentif = ["(user.CustomAttribute['Segment'] == 'Y') || (user.CustomAttribute['Segment'] == 'Z')"]
...
path='email_modules/preheader'
color='''nothing'''
segmentelseif = ["(user.CustomAttribute['Segment'] == 'AA') || (user.CustomAttribute['Segment'] == 'AB')"]
...
color='''green_pb'''
segmentif = ["(user.CustomAttribute['Segment'] == 'Z') || (user.CustomAttribute['Segment'] == 'AB')"]
