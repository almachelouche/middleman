+++
markets = ["in"]
title = '''IN Service Reminder First Due 007 all'''
draft=true
...
path='email_modules/cover/02'
color='''green_pb'''
segmentif = ["((user.CustomAttribute['Model'] == 'Figo') || (user.CustomAttribute['Model'] == 'EcoSport') || (user.CustomAttribute['Model'] == 'Aspire') || (user.CustomAttribute['Model'] == 'New Figo')) && (user.CustomAttribute['EWStatus'] == 'NO')"]
...
path='email_modules/cover/02'
color='''green_pb'''
segmentelseif = ["((user.CustomAttribute['Model'] == 'Classic') || (user.CustomAttribute['Model'] == 'New Fiesta')) && (user.CustomAttribute['EWStatus'] == 'NO')"]
...
path='email_modules/cover/02'
color='''green_pb'''
segmentelseif = ["((user.CustomAttribute['Model'] == 'Endeavour')) && (user.CustomAttribute['EWStatus'] == 'NO')"]
