+++
markets = ["in"]
title = '''IN Service Reminder Regular Due/Pdue 012 All'''
draft=true
...
segmentelseif = ["(user.CustomAttribute['Esplit'] == 'PastDue')"]
	...
	preheader = '''For the wellbeing of you and your Ford, visit a Ford service centre soon. Hello <%${user.CustomAttribute['FullName']}%>, your Ford <%${user.CustomAttribute['Model']}%>'s service is overdue. For the wellbeing of you and your Ford, it's important that you visit a Ford service centre soon.'''
