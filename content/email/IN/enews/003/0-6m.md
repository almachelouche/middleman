...
color='black'
  ...
  title = '''Insider'''
  date = '''02 May 2017'''
  copy = '''IN THIS ISSUE:<br /> Ford Service Journey | Parking lot safety | First-time driver? | Ford Owners App'''
...
color='darkblue'
  ...
  copy = '''The fact drivers think parking lots are safe places is what makes them so dangerous. Parking lot crashes account for 14% of all insurance claims. Avoid danger by following these seven simple points.'''
...
color='green'
  ...
  copy = '''Your first real drive can feel a bit daunting. That's totally normal. The important thing is that you stay safe on the road. So check out our safety checklist for new drivers.'''
