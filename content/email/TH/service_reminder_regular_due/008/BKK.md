...
copy='''สบายใจ งบไม่บานปลาย เมื่อซื้อโปรแกรมขับขี่อุ่นใจก่อนรถฟอร์ดของคุณครบ 35 เดือนหรือ 100,000 กิโลเมตร  (แล้วแต่อย่างหนึ่งอย่างใดถึงก่อน) โปรแกรมนี้ช่วยเพิ่ม
ความอบอุ่นใจในการขับขี่รถยนต์ให้คุณทุกเส้นทาง โดยไม่ต้องกังวลกับค่าใช้จ่าย หรือ
การซ่อมแซมที่ไม่ได้คาดคิดที่อาจเกิดขึ้นในอนาคต และยังช่วยเพิ่มมูลค่าในการขายรถต่อในอนาคตอีกด้วย  '''
