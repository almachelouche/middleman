+++
markets = ["th"]
title = '''TH Service Reminder First Past Due 010 Version B'''
draft = true
...
title='''Your <%${user.CustomAttribute['Model']}%> missed important service'''
copy='''We noticed your <%${user.CustomAttribute['Model']}%> is overdue for its first service. This service is just a quick check to make sure your Ford is still running at its absolute best.<br /><br />It's important to book your service today. Just click below to contact <Ford Dealership> (during business hours) or to find your nearest dealer.'''
