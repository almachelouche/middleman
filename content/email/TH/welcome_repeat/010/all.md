...
color='''nothing'''
	...
	preheader = '''ไม่ว่าฟอร์ดคันนี้เป็นรถใหม่คันแรก หรือคันที่เท่าไรของคุณก็ตาม เราเข้าใจดีว่าการได้ครอบครองและขับขี่รถยนต์คันใหม่ เป็นความรู้สึกอันแสนวิเศษ'''
...
title1 = '''<span style="font-family:Tahoma, Verdana, Sans-serif">นย์ข้อมูลเพื่อเจ้าของรถฟอร์ด</span>'''
